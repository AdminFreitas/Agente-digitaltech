"""
llm_service.py — Fallback Chain de modelos de linguagem (CORRIGIDO v4)
...
def _tentar_gemini(prompt: str) -> str:
    """
    Usa o SDK google-genai (novo) em vez de google-generativeai (deprecado).
    Modelo: gemini-3.6-flash (modelos 1.x/2.x/2.5 descontinuados).
    """
    if not GEMINI_KEY:
